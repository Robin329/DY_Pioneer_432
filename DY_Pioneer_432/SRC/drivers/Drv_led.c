...
void Drv_LED_Init()
{
	...
	//	0 1 0 0白
	GPIO_ResetBits(ANO_GPIO_LED, ANO_Pin_LED1);		//PE3
	GPIO_SetBits(ANO_GPIO_LED, ANO_Pin_LED2);		//PE2
	GPIO_ResetBits(ANO_GPIO_LED, ANO_Pin_LED3);		//PE1
	GPIO_ResetBits(ANO_GPIO_LED, ANO_Pin_LED4);		//PE0
...
//			}			
		...
		case 13: //闪1次B_led
					{
						led_flash(dT_ms,0,20,1,400,100,300) ;
						j = led_flash(dT_ms,B_led,20,1,400,100,300) ;
		...
		case 14: //闪2次B_led				
					{
						led_flash(dT_ms,0,20,1,400,100,300) ;
						j = led_flash(dT_ms,B_led,20,2,200,200,300) ;
		...
		case 15://闪3次B_led
					{
						LED_Brightness[0] = 20;
						j = led_flash(dT_ms,B_led,20,3,200,200,300) ;
		...
		case 23: //闪1次R_led
					{
						led_flash(dT_ms,0,20,1,400,100,300) ;
						j = led_flash(dT_ms,R_led,20,1,400,100,300) ;
		...
		case 24: //闪2次R_led				
					{
						led_flash(dT_ms,0,20,1,400,100,300) ;
						j = led_flash(dT_ms,R_led,20,2,200,200,300) ;
		...
		case 25://闪3次R_led
					{
						LED_Brightness[0] = 20;
						j = led_flash(dT_ms,R_led,20,3,200,200,300) ;
